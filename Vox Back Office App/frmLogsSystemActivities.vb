...
Public Class frmLogsSystemActivities
    ...
    Private Sub frmLogsSystemActivities_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With lsvItems.Columns
            ...
            .Add("Server", 100, HorizontalAlignment.Left)
            .Add("Source", 150, HorizontalAlignment.Left)
            .Add("Description", 500, HorizontalAlignment.Left)
            .Add("Location", 250, HorizontalAlignment.Left)
        ...
        With cmbFilter1
            ...
            vDataRow1 = vDataTable1.NewRow
            vDataRow1(0) = "Source"
            vDataRow1(1) = "ssource_id"
            vDataTable1.Rows.Add(vDataRow1)

            vDataRow1 = vDataTable1.NewRow
            vDataRow1(0) = "Description"
            vDataRow1(1) = "serror_description"
            vDataTable1.Rows.Add(vDataRow1)

            vDataRow1 = vDataTable1.NewRow
            vDataRow1(0) = "Location"
            vDataRow1(1) = "slocation"
            vDataTable1.Rows.Add(vDataRow1)
        ...
        With cmbFilter2
            ...
            vDataRow2 = vDataTable2.NewRow
            vDataRow2(0) = "Source"
            vDataRow2(1) = "ssource_id"
            vDataTable2.Rows.Add(vDataRow2)

            vDataRow2 = vDataTable2.NewRow
            vDataRow2(0) = "Description"
            vDataRow2(1) = "serror_description"
            vDataTable2.Rows.Add(vDataRow2)

            vDataRow2 = vDataTable2.NewRow
            vDataRow2(0) = "Location"
            vDataRow2(1) = "slocation"
            vDataTable2.Rows.Add(vDataRow2)
        ...
        'log event
        vTmpStr = modModule.CreateLog(Me.Name, "System Logs - Open", "")
    ...
    Private Sub timerDataLoad_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles timerDataLoad.Tick
        ...
        Try
            ...
            If txtFilterDateFrom.Text <> "" And txtFilterDateTo.Text <> "" Then
                vFilter = vFilter & " WHERE (period :: date >= '" & Format(CDate(txtFilterDateFrom.Text), "yyyy-MM-dd") & "' AND " & _
                    "period :: date <= '" & Format(CDate(txtFilterDateTo.Text), "yyyy-MM-dd") & "')"
            End If

            If txtServer.Text <> "" Then
                vFilter = vFilter & IIf(Trim(vFilter) = "", " WHERE ", " AND ") & "LOWER(server_id) LIKE '%" & LCase(txtServer.Text) & "%'"
            End If
            ...
            vQuery = "SELECT recno, server_id, source_id, error_description, location, period FROM tb_logs " & vFilter & " " & vSortBy
            ...
            Else
                ...
                Do While vFound = True
                    ...
                    If IsDBNull(vMyPgRd("server_id")) = True Then
                        lsvItems.Items(lsvItems.Items.Count - 1).SubItems.Add("")
                    Else
                        lsvItems.Items(lsvItems.Items.Count - 1).SubItems.Add(vMyPgRd("server_id"))
                    End If

                    If IsDBNull(vMyPgRd("source_id")) = True Then
                        lsvItems.Items(lsvItems.Items.Count - 1).SubItems.Add("")
                    Else
                        lsvItems.Items(lsvItems.Items.Count - 1).SubItems.Add(vMyPgRd("source_id"))
                    End If

                    If IsDBNull(vMyPgRd("error_description")) = True Then
                        lsvItems.Items(lsvItems.Items.Count - 1).SubItems.Add("")
                    Else
                        lsvItems.Items(lsvItems.Items.Count - 1).SubItems.Add(vMyPgRd("error_description"))
                    End If

                    If IsDBNull(vMyPgRd("location")) = True Then
                        lsvItems.Items(lsvItems.Items.Count - 1).SubItems.Add("")
                    Else
                        lsvItems.Items(lsvItems.Items.Count - 1).SubItems.Add(vMyPgRd("location"))
                    End If
    ...
    Private Sub frmLogsSystemActivities_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
    ...
    Private Sub cmdClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdClose.Click
        ...
        'log event
        vTmpStr = modModule.CreateLog(Me.Name, "System Logs - Close", "")
    ...
    Private Sub txtServer_LostFocus(sender As Object, e As EventArgs) Handles txtServer.LostFocus
        txtServer.Text = Trim(modModule.StripInvalidStringChars(txtServer.Text))
    End Sub
